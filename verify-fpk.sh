...
if fields.get("fpk_version") != "0.1.0-r1":
...
if ! grep -q 'image: ghcr.io/dttxorg/livemotion:0.1.0' "$TMP_DIR/app/docker/docker-compose.yaml"; then
    fail "docker-compose.yaml missing prebuilt image ghcr.io/dttxorg/livemotion:0.1.0"
fi
